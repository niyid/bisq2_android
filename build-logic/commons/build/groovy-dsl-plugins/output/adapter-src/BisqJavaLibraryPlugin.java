...
/**
 * Precompiled bisq.java-library script plugin.
 **/
public class BisqJavaLibraryPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_BisqJavaLibrary").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("bisq.java-conventions");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_BisqJavaLibrary").asSubclass(BasicScript.class);
