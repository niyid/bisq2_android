...
/**
 * Precompiled bisq.protobuf script plugin.
 **/
public class BisqProtobufPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_BisqProtobuf").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("com.google.protobuf");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_BisqProtobuf").asSubclass(BasicScript.class);
